...
/**
    ...
    @notice This contract stores:
        ...
        // q: what is token , what does this represent ?
        // a: token e ERC20 token
        // q: is token the collateral token against which whom the protocol gives out the respective lending token ?
        // a: da
...
contract Registry is Ownable, IRegistry {
    ...
    // a: keys is a list of contract names
    // q: why do we need keys ?
    // a: we need keys to be able to iterate over the list of contracts
    // a: via string t.e. contract name se smeta kako contract id, vidi podole
    string[] public keys;
